...
This repository currently generates the CV page from [\_data/cv.yml](_data/cv.yml).

The upstream template can also be wired to a JSON Resume file, but that optional data source is not included in this fork.
